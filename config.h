...
static const Key keys[] = {
  ...
  { MODKEY,                       XK_Print,                 spawn,          {.v = scrot_window_cmd } },
  { ShiftMask,                    XK_Print,                 spawn,          {.v = scrot_select_cmd } },
  { ControlMask,                  XK_Print,                 spawn,          {.v = scrot_clipboard_cmd } },
  { ControlMask|MODKEY,           XK_Print,                 spawn,          {.v = scrot_clipboard_window_cmd } },
  { ControlMask|ShiftMask,        XK_Print,                 spawn,          {.v = scrot_clipboard_select_cmd } },
};
